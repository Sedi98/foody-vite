    ...
    <>
      <div className="w-full flex flex-col-reverse md:flex-row gap-8">
        <div className="w-full bg-[#f3f4f6] rounded-md p-7">
          <h2 className="font-semibold text-3xl text-neutral-700">Checkout</h2>
          ...
          <div className="paymet mt-4">
            ...
            <div className="flex gap-8 ">
              <div
                ...
                onClick={() => setInputVal({ ...inputVal, payment_method: 0 })}
              >
                <img
              ...
              <div
                className="flex gap-2 items-center"
                onClick={() => setInputVal({ ...inputVal, payment_method: 1 })}
              >
                <img
